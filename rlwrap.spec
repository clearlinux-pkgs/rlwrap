...
Source0  : https://github.com/hanslub42/rlwrap/releases/download/0.44/rlwrap-0.44.tar.gz
...
%prep
%setup -q -n rlwrap-0.44
cd %{_builddir}/rlwrap-0.44
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612292677
...
cp %{_builddir}/rlwrap-0.44/COPYING %{buildroot}/usr/share/package-licenses/rlwrap/dfac199a7539a404407098a2541b9482279f690d
%make_install
