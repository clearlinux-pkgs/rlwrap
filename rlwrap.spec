...
Version  : 0.45.1
Release  : 4
URL      : https://github.com/hanslub42/rlwrap/archive/v0.45.1/rlwrap-0.45.1.tar.gz
Source0  : https://github.com/hanslub42/rlwrap/archive/v0.45.1/rlwrap-0.45.1.tar.gz
...
%prep
%setup -q -n rlwrap-0.45.1
cd %{_builddir}/rlwrap-0.45.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621435953
...
cp %{_builddir}/rlwrap-0.45.1/COPYING %{buildroot}/usr/share/package-licenses/rlwrap/dfac199a7539a404407098a2541b9482279f690d
%make_install
