...
Version  : 0.46
Release  : 6
URL      : https://github.com/hanslub42/rlwrap/archive/v0.46/rlwrap-0.46.tar.gz
Source0  : https://github.com/hanslub42/rlwrap/archive/v0.46/rlwrap-0.46.tar.gz
...
%prep
%setup -q -n rlwrap-0.46
cd %{_builddir}/rlwrap-0.46
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666311137
