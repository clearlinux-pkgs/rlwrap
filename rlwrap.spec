...
Source0  : https://github.com/hanslub42/rlwrap/archive/v0.45/rlwrap-0.45.tar.gz
...
%prep
%setup -q -n rlwrap-0.45
cd %{_builddir}/rlwrap-0.45
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613056700
...
cp %{_builddir}/rlwrap-0.45/COPYING %{buildroot}/usr/share/package-licenses/rlwrap/dfac199a7539a404407098a2541b9482279f690d
%make_install
