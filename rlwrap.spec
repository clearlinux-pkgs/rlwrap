...
Source0  : https://github.com/hanslub42/rlwrap/releases/download/v0.43/rlwrap-0.43.tar.gz
...
%prep
%setup -q -n rlwrap-0.43
cd %{_builddir}/rlwrap-0.43
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582313145
...
cp %{_builddir}/rlwrap-0.43/COPYING %{buildroot}/usr/share/package-licenses/rlwrap/dfac199a7539a404407098a2541b9482279f690d
%make_install
